...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="<?php echo Yii::app()->theme->baseUrl;?>/ico/OPS - Logo.png">
  </head>
  <body>
...
<footer class="footer bg-ft clearfix pd4">
        ...
        <div class="row-fluid">
            <div class="span3">
                <section>
                    ...
                    <p>Dpto. Sistemas y Tecnologías<br>
                        123456 <br>
                        Neuquén, Argentina<br>
                        <strong>Teléfono:</strong> <a href="tel:123456789" class="tele">123456789</a><br>
                        <strong>Fax:</strong> 123456789<br>
                        <span class="overflow"><strong>Email:</strong> <a href="mailto:email@domain.com">soporte@opsargentina.com.ar</a></span> </p>
                </section>
                <!--close section-->
            ...
            <div class="span5">
                <section>
                    <h4><span>Recibir Actualizaciones</span></h4>
                    <p>Ingresa tú dirección de correo electrónico y recibí todas nuestras actualizaciones.</p>
            ...
            <div class="span4">
                <section>
                    <h4><span>RSE</span></h4>
                    <p>
                      Responsabilidad real y consciente. ​Desde nuestros inicios, ​m​antenemos el compromiso de seguir llevando a cabo 
                      acciones para promover y difundir el concepto y la práctica de la Responsabilidad Social Empresarial, 
                      impulsando el desarrollo sustentable en el país.​
                    </p>
                </section>
            </div>
            <!-- close .span4 -->
 ...
 <section class="footer-credits">
    <div class="container">
        <ul class="clearfix">
            <li>© 2015 OPS. Todos los derecos reservados.</li>
            <li><a href="#">Link</a></li>
            <li><a href="#">Link</a></li>
        </ul>
    </div>
