...
class Sala extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'salaFuncions' => array(self::HAS_MANY, 'SalaFuncion', 'sala_id'),
			'salaTipos' => array(self::HAS_MANY, 'SalaTipo', 'sala_id'),
		);
	}
